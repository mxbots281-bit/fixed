...
def init_db():
    ...
    user_new_cols = [('user_session', 'TEXT')]
...
async def handle_text_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # ── PROTECTION: Check if registered and session is valid ──
    if state not in ("reg_phone", "reg_code", "reg_password", "reg_key") and not is_owner(user_id):
        ...
        # Periodic/Action-based session check
